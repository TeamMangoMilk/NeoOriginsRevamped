 ...
 *
 * <p>These are client-only preferences. They are never synced from the server.
 */
public final class NeoOriginsClientConfig {
    ...
    /** True if natural-glide should play the vanilla elytra loop. */
    public static boolean naturalGlideElytraSound() { return NATURAL_GLIDE_ELYTRA_SOUND.get(); }
