...
public final class CompatRegistries {
    ...
    public static final ResourceKey<Registry<ActionType>> ACTION_TYPE_KEY =
        ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(NeoOrigins.MOD_ID, "action_type"));
    public static final ResourceKey<Registry<ConditionType>> CONDITION_TYPE_KEY =
        ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(NeoOrigins.MOD_ID, "condition_type"));
    public static final ResourceKey<Registry<ItemActionType>> ITEM_ACTION_TYPE_KEY =
        ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(NeoOrigins.MOD_ID, "item_action_type"));
    public static final ResourceKey<Registry<ItemConditionType>> ITEM_CONDITION_TYPE_KEY =
        ResourceKey.createRegistryKey(ResourceLocation.fromNamespaceAndPath(NeoOrigins.MOD_ID, "item_condition_type"));
    ...
    // ── Lookups ───────────────────────────────────────────────────────────────
    public static ActionType action(ResourceLocation id) {
        return ACTION_REGISTRY == null ? null : ACTION_REGISTRY.get(id);
    }
    public static ConditionType condition(ResourceLocation id) {
        return CONDITION_REGISTRY == null ? null : CONDITION_REGISTRY.get(id);
    }
    public static ItemActionType itemAction(ResourceLocation id) {
        return ITEM_ACTION_REGISTRY == null ? null : ITEM_ACTION_REGISTRY.get(id);
    }
    public static ItemConditionType itemCondition(ResourceLocation id) {
        return ITEM_CONDITION_REGISTRY == null ? null : ITEM_CONDITION_REGISTRY.get(id);
    }

    // ── Key sets (the future source for the parsers' KNOWN_TYPES) ───────────────
    public static Set<ResourceLocation> actionKeys() {
        return ACTION_REGISTRY == null ? Set.of() : ACTION_REGISTRY.keySet();
    }
    public static Set<ResourceLocation> conditionKeys() {
        return CONDITION_REGISTRY == null ? Set.of() : CONDITION_REGISTRY.keySet();
    }
    public static Set<ResourceLocation> itemActionKeys() {
        return ITEM_ACTION_REGISTRY == null ? Set.of() : ITEM_ACTION_REGISTRY.keySet();
    }
    public static Set<ResourceLocation> itemConditionKeys() {
