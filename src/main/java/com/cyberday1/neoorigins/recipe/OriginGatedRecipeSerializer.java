...
/**
 * Codecs for {@link OriginGatedRecipe}.
 *
 * <p>JSON layout:
 * <pre>
 * {
 ...
 *
 * <p><b>26.1 note:</b> {@code RecipeSerializer} became a {@code record}
 * (carrying {@code MapCodec} + {@code StreamCodec}), so there is no interface to
 * implement — these codecs are constructed into a {@code RecipeSerializer<>}
 * instance in {@link OriginRecipeRegistry}.
 */
public final class OriginGatedRecipeSerializer {

    private OriginGatedRecipeSerializer() {}

    public static final MapCodec<OriginGatedRecipe> MAP_CODEC = RecordCodecBuilder.mapCodec(inst -> inst.group(
    ...
    public static final StreamCodec<RegistryFriendlyByteBuf, OriginGatedRecipe> STREAM_CODEC =
