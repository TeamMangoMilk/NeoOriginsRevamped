 ...
 * {@link net.minecraft.world.inventory.CraftingMenu}'s static
 * {@code slotChangedCraftingGrid} and read it back from
 * {@link OriginGatedRecipe#matches}.
 *
 * <p>The slot is per-thread because crafting evaluation is single-threaded
 * within the server tick — the same thread that drives {@code slotChangedCraftingGrid}
