 ...
 *
 * @param originId    full ResourceLocation of the source origin (e.g. {@code neoorigins:abyssal}).
...
public record OriginTemplate(
        ...
        int impact,
        String originBody,
        LinkedHashMap<ResourceLocation, String> powers) {
    ...
    public Map<ResourceLocation, String> powersView() {
