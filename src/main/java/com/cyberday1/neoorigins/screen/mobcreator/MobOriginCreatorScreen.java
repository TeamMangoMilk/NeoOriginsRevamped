 ...
 * (26.1 form: {@code extractRenderState}/{@code GuiGraphicsExtractor}, no
 * {@code flush()}). Implements {@link CreatorHost} so the shared picker/form
 * widgets work verbatim. Save/Apply feedback reuses {@code ClientCreatorState}.
 */
